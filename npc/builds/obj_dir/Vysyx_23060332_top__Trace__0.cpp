...
void Vysyx_23060332_top___024root__trace_chg_sub_0(Vysyx_23060332_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(((vlSelf->__Vm_traceActivity[1U] 
        ...
        bufp->chgIData(oldp+0,(vlSelf->ysyx_23060332_top__DOT__op1),32);
        bufp->chgIData(oldp+1,(vlSelf->ysyx_23060332_top__DOT__op2),32);
        bufp->chgIData(oldp+2,(vlSelf->ysyx_23060332_top__DOT__op1_jump),32);
        bufp->chgIData(oldp+3,(vlSelf->ysyx_23060332_top__DOT__op2_jump),32);
        bufp->chgBit(oldp+4,(vlSelf->ysyx_23060332_top__DOT__id_ex_reg_wen));
        bufp->chgCData(oldp+5,(vlSelf->ysyx_23060332_top__DOT__id_ex_waddr),5);
    ...
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[1U] 
        ...
        bufp->chgIData(oldp+8,(vlSelf->ysyx_23060332_top__DOT__inst),32);
        bufp->chgCData(oldp+9,((0x7fU & vlSelf->ysyx_23060332_top__DOT__inst)),7);
        bufp->chgCData(oldp+10,((7U & (vlSelf->ysyx_23060332_top__DOT__inst 
                                       >> 0xcU))),3);
        bufp->chgCData(oldp+11,((0x1fU & (vlSelf->ysyx_23060332_top__DOT__inst 
                                          >> 7U))),5);
        bufp->chgCData(oldp+12,((0x1fU & (vlSelf->ysyx_23060332_top__DOT__inst 
                                          >> 0xfU))),5);
        bufp->chgCData(oldp+13,((0x1fU & (vlSelf->ysyx_23060332_top__DOT__inst 
                                          >> 0x14U))),5);
        bufp->chgSData(oldp+14,((vlSelf->ysyx_23060332_top__DOT__inst 
                                 >> 0x14U)),12);
    }
    if (VL_UNLIKELY(((vlSelf->__Vm_traceActivity[2U] 
                      | vlSelf->__Vm_traceActivity[4U]) 
                     | vlSelf->__Vm_traceActivity[7U]))) {
        bufp->chgIData(oldp+15,(vlSelf->ysyx_23060332_top__DOT__jump_addr),32);
        bufp->chgBit(oldp+16,(vlSelf->ysyx_23060332_top__DOT__jump_en));
        bufp->chgIData(oldp+17,(vlSelf->ysyx_23060332_top__DOT__ex_reg_wdata),32);
        bufp->chgBit(oldp+18,(vlSelf->ysyx_23060332_top__DOT__ex_reg_reg_wen));
        bufp->chgBit(oldp+19,(vlSelf->ysyx_23060332_top__DOT__mem_wen));
        bufp->chgIData(oldp+20,(vlSelf->ysyx_23060332_top__DOT__mem_waddr),32);
        bufp->chgIData(oldp+21,(vlSelf->ysyx_23060332_top__DOT__mem_wdata),32);
        bufp->chgCData(oldp+22,(vlSelf->ysyx_23060332_top__DOT__mem_wmask),8);
        bufp->chgIData(oldp+23,(vlSelf->ysyx_23060332_top__DOT__mem_raddr),32);
        bufp->chgIData(oldp+24,(vlSelf->ysyx_23060332_top__DOT__mem_rdata),32);
        bufp->chgBit(oldp+25,(vlSelf->ysyx_23060332_top__DOT__mem_ren));
    }
