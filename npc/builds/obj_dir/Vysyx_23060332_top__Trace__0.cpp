...
void Vysyx_23060332_top___024root__trace_chg_sub_0(Vysyx_23060332_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[1U] 
        ...
        bufp->chgBit(oldp+16,(vlSelf->ysyx_23060332_top__DOT__ex_reg_reg_wen));
        bufp->chgBit(oldp+17,(vlSelf->ysyx_23060332_top__DOT__mem_wen));
        bufp->chgCData(oldp+18,(vlSelf->ysyx_23060332_top__DOT__mem_wmask),8);
        bufp->chgBit(oldp+19,(vlSelf->ysyx_23060332_top__DOT__mem_ren));
    ...
    bufp->chgIData(oldp+64,(((0U == (IData)(vlSelf->ysyx_23060332_top__DOT__raddr2))
