...
VL_ATTR_COLD void Vysyx_23060332_top___024root___dump_triggers__stl(Vysyx_23060332_top___024root* vlSelf) {
    ...
    if (vlSelf->__VstlTriggered.at(1U)) {
        VL_DBG_MSGF("         'stl' region trigger index 1 is active: @([hybrid] ysyx_23060332_top.reg_rdata1)\n");
    }
}
#endif  // VL_DEBUG

void Vysyx_23060332_top___024root___ico_sequent__TOP__0(Vysyx_23060332_top___024root* vlSelf);
void Vysyx_23060332_top___024root___ico_comb__TOP__0(Vysyx_23060332_top___024root* vlSelf);
...
VL_ATTR_COLD void Vysyx_23060332_top___024root___dump_triggers__ico(Vysyx_23060332_top___024root* vlSelf) {
    ...
    if (vlSelf->__VicoTriggered.at(1U)) {
        VL_DBG_MSGF("         'ico' region trigger index 1 is active: @([hybrid] ysyx_23060332_top.reg_rdata1)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vysyx_23060332_top___024root___dump_triggers__act(Vysyx_23060332_top___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(0U)) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @([hybrid] ysyx_23060332_top.reg_rdata1)\n");
    }
...
VL_ATTR_COLD void Vysyx_23060332_top___024root___dump_triggers__nba(Vysyx_23060332_top___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(0U)) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @([hybrid] ysyx_23060332_top.reg_rdata1)\n");
    }
...
VL_ATTR_COLD void Vysyx_23060332_top___024root___ctor_var_reset(Vysyx_23060332_top___024root* vlSelf) {
    ...
    vlSelf->ysyx_23060332_top__DOT__ysyx_23060332_mem_inst__DOT__rdata = 0;
    vlSelf->__Vtrigrprev__TOP__ysyx_23060332_top__DOT__reg_rdata1 = 0;
