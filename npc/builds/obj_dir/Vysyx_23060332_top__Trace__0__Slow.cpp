...
VL_ATTR_COLD void Vysyx_23060332_top___024root__trace_init_sub__TOP__0(Vysyx_23060332_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+56,"reg_rdata1", false,-1, 31,0);
    tracep->declBus(c+57,"reg_rdata2", false,-1, 31,0);
    tracep->declBus(c+7,"op1", false,-1, 31,0);
    tracep->declBus(c+8,"op2", false,-1, 31,0);
    tracep->declBus(c+9,"op1_jump", false,-1, 31,0);
    tracep->declBus(c+10,"op2_jump", false,-1, 31,0);
    tracep->declBit(c+11,"id_ex_reg_wen", false,-1);
    tracep->declBus(c+12,"id_ex_waddr", false,-1, 4,0);
    tracep->declBus(c+54,"id_ex_inst", false,-1, 31,0);
    tracep->declBus(c+56,"id_ex_reg_rdata1", false,-1, 31,0);
    tracep->declBus(c+57,"id_ex_reg_rdata2", false,-1, 31,0);
    tracep->declBus(c+13,"raddr1", false,-1, 4,0);
    tracep->declBus(c+14,"raddr2", false,-1, 4,0);
    tracep->declBus(c+12,"ex_reg_waddr", false,-1, 4,0);
    tracep->declBus(c+15,"ex_reg_wdata", false,-1, 31,0);
    tracep->declBit(c+2,"ex_reg_reg_wen", false,-1);
    tracep->declBit(c+3,"mem_wen", false,-1);
    tracep->declBit(c+4,"mem_valid", false,-1);
    tracep->declBus(c+16,"mem_waddr", false,-1, 31,0);
    tracep->declBus(c+17,"mem_wdata", false,-1, 31,0);
    tracep->declBus(c+5,"mem_wmask", false,-1, 7,0);
    tracep->declBus(c+64,"mem_raddr", false,-1, 31,0);
    tracep->declBus(c+65,"mem_rdata", false,-1, 31,0);
    tracep->pushNamePrefix("ysyx_23060332_exu_inst ");
    tracep->declBus(c+7,"op1", false,-1, 31,0);
    tracep->declBus(c+8,"op2", false,-1, 31,0);
    tracep->declBus(c+9,"op1_jump", false,-1, 31,0);
    tracep->declBus(c+10,"op2_jump", false,-1, 31,0);
    tracep->declBus(c+56,"reg_rdata1_i", false,-1, 31,0);
    tracep->declBus(c+57,"reg_rdata2_i", false,-1, 31,0);
    tracep->declBit(c+11,"reg_wen_i", false,-1);
    tracep->declBus(c+12,"waddr_i", false,-1, 4,0);
    ...
    tracep->declBus(c+5,"mem_wmask", false,-1, 7,0);
    tracep->declBus(c+64,"mem_raddr", false,-1, 31,0);
    tracep->declBus(c+12,"waddr_o", false,-1, 4,0);
    ...
    tracep->declBus(c+9,"op1_jump", false,-1, 31,0);
    tracep->declBus(c+10,"op2_jump", false,-1, 31,0);
    tracep->declBus(c+56,"reg_rdata1_o", false,-1, 31,0);
    tracep->declBus(c+57,"reg_rdata2_o", false,-1, 31,0);
    ...
    tracep->declBus(c+63,"imm", false,-1, 11,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vysyx_23060332_top___024root__trace_full_sub_0(Vysyx_23060332_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+4,(vlSelf->ysyx_23060332_top__DOT__mem_valid));
    ...
    bufp->fullIData(oldp+7,(vlSelf->ysyx_23060332_top__DOT__op1),32);
    bufp->fullIData(oldp+8,(vlSelf->ysyx_23060332_top__DOT__op2),32);
    bufp->fullIData(oldp+9,(vlSelf->ysyx_23060332_top__DOT__op1_jump),32);
    bufp->fullIData(oldp+10,(vlSelf->ysyx_23060332_top__DOT__op2_jump),32);
    bufp->fullBit(oldp+11,(vlSelf->ysyx_23060332_top__DOT__id_ex_reg_wen));
    bufp->fullCData(oldp+12,(vlSelf->ysyx_23060332_top__DOT__id_ex_waddr),5);
    bufp->fullCData(oldp+13,(vlSelf->ysyx_23060332_top__DOT__raddr1),5);
    bufp->fullCData(oldp+14,(vlSelf->ysyx_23060332_top__DOT__raddr2),5);
    bufp->fullIData(oldp+15,(vlSelf->ysyx_23060332_top__DOT__ex_reg_wdata),32);
    bufp->fullIData(oldp+16,(vlSelf->ysyx_23060332_top__DOT__mem_waddr),32);
    bufp->fullIData(oldp+17,(vlSelf->ysyx_23060332_top__DOT__mem_wdata),32);
    ...
    bufp->fullIData(oldp+56,(vlSelf->ysyx_23060332_top__DOT__reg_rdata1),32);
    bufp->fullIData(oldp+57,(((0U == (IData)(vlSelf->ysyx_23060332_top__DOT__raddr2))
                               ? 0U : vlSelf->ysyx_23060332_top__DOT__ysyx_23060332_reg_inst__DOT__regs
                              [vlSelf->ysyx_23060332_top__DOT__raddr2])),32);
    bufp->fullCData(oldp+58,((0x7fU & vlSelf->inst)),7);
    bufp->fullCData(oldp+59,((7U & (vlSelf->inst >> 0xcU))),3);
    bufp->fullCData(oldp+60,((0x1fU & (vlSelf->inst 
                                       >> 7U))),5);
    bufp->fullCData(oldp+61,((0x1fU & (vlSelf->inst 
                                       >> 0xfU))),5);
    bufp->fullCData(oldp+62,((0x1fU & (vlSelf->inst 
                                       >> 0x14U))),5);
    bufp->fullSData(oldp+63,((vlSelf->inst >> 0x14U)),12);
    bufp->fullIData(oldp+64,(0U),32);
    bufp->fullIData(oldp+65,(vlSelf->ysyx_23060332_top__DOT__ysyx_23060332_mem_inst__DOT__rdata),32);
}
