...
VL_ATTR_COLD void Vysyx_23060332_top___024root__trace_init_sub__TOP__0(Vysyx_23060332_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+62,"rst", false,-1);
    tracep->declBus(c+63,"pc", false,-1, 31,0);
    tracep->declBus(c+16,"jump_addr", false,-1, 31,0);
    tracep->declBit(c+17,"jump_en", false,-1);
    ...
    tracep->declBus(c+3,"op1_jump", false,-1, 31,0);
    tracep->declBus(c+4,"op2_jump", false,-1, 31,0);
    tracep->declBit(c+5,"id_ex_reg_wen", false,-1);
    tracep->declBus(c+6,"id_ex_waddr", false,-1, 4,0);
    ...
    tracep->declBus(c+6,"ex_reg_waddr", false,-1, 4,0);
    tracep->declBus(c+18,"ex_reg_wdata", false,-1, 31,0);
    tracep->declBit(c+19,"ex_reg_reg_wen", false,-1);
    tracep->declBit(c+20,"mem_wen", false,-1);
    tracep->declBus(c+21,"mem_waddr", false,-1, 31,0);
    tracep->declBus(c+22,"mem_wdata", false,-1, 31,0);
    tracep->declBus(c+23,"mem_wmask", false,-1, 7,0);
    tracep->declBus(c+24,"mem_raddr", false,-1, 31,0);
    tracep->declBus(c+25,"mem_rdata", false,-1, 31,0);
    tracep->declBit(c+26,"mem_ren", false,-1);
    ...
    tracep->declBit(c+5,"reg_wen_i", false,-1);
    tracep->declBus(c+6,"waddr_i", false,-1, 4,0);
    ...
    tracep->declBus(c+24,"mem_raddr", false,-1, 31,0);
    tracep->declBit(c+26,"mem_ren", false,-1);
    tracep->declBus(c+6,"waddr_o", false,-1, 4,0);
    ...
    tracep->declBit(c+5,"reg_wen", false,-1);
    ...
    tracep->declBus(c+15,"imm", false,-1, 11,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vysyx_23060332_top___024root__trace_full_sub_0(Vysyx_23060332_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullIData(oldp+1,(vlSelf->ysyx_23060332_top__DOT__op1),32);
    bufp->fullIData(oldp+2,(vlSelf->ysyx_23060332_top__DOT__op2),32);
    bufp->fullIData(oldp+3,(vlSelf->ysyx_23060332_top__DOT__op1_jump),32);
    bufp->fullIData(oldp+4,(vlSelf->ysyx_23060332_top__DOT__op2_jump),32);
    bufp->fullBit(oldp+5,(vlSelf->ysyx_23060332_top__DOT__id_ex_reg_wen));
    bufp->fullCData(oldp+6,(vlSelf->ysyx_23060332_top__DOT__id_ex_waddr),5);
    ...
    bufp->fullIData(oldp+9,(vlSelf->ysyx_23060332_top__DOT__inst),32);
    bufp->fullCData(oldp+10,((0x7fU & vlSelf->ysyx_23060332_top__DOT__inst)),7);
    bufp->fullCData(oldp+11,((7U & (vlSelf->ysyx_23060332_top__DOT__inst 
                                    >> 0xcU))),3);
    bufp->fullCData(oldp+12,((0x1fU & (vlSelf->ysyx_23060332_top__DOT__inst 
                                       >> 7U))),5);
    bufp->fullCData(oldp+13,((0x1fU & (vlSelf->ysyx_23060332_top__DOT__inst 
                                       >> 0xfU))),5);
    bufp->fullCData(oldp+14,((0x1fU & (vlSelf->ysyx_23060332_top__DOT__inst 
                                       >> 0x14U))),5);
    bufp->fullSData(oldp+15,((vlSelf->ysyx_23060332_top__DOT__inst 
                              >> 0x14U)),12);
    bufp->fullIData(oldp+16,(vlSelf->ysyx_23060332_top__DOT__jump_addr),32);
    bufp->fullBit(oldp+17,(vlSelf->ysyx_23060332_top__DOT__jump_en));
    bufp->fullIData(oldp+18,(vlSelf->ysyx_23060332_top__DOT__ex_reg_wdata),32);
    bufp->fullBit(oldp+19,(vlSelf->ysyx_23060332_top__DOT__ex_reg_reg_wen));
    bufp->fullBit(oldp+20,(vlSelf->ysyx_23060332_top__DOT__mem_wen));
    bufp->fullIData(oldp+21,(vlSelf->ysyx_23060332_top__DOT__mem_waddr),32);
    bufp->fullIData(oldp+22,(vlSelf->ysyx_23060332_top__DOT__mem_wdata),32);
    bufp->fullCData(oldp+23,(vlSelf->ysyx_23060332_top__DOT__mem_wmask),8);
    bufp->fullIData(oldp+24,(vlSelf->ysyx_23060332_top__DOT__mem_raddr),32);
    bufp->fullIData(oldp+25,(vlSelf->ysyx_23060332_top__DOT__mem_rdata),32);
    bufp->fullBit(oldp+26,(vlSelf->ysyx_23060332_top__DOT__mem_ren));
